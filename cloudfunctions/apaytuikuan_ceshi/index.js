...
async function tuikuantongzhi(openid, dingdanhao, dingdan_money, tk_time, tuikuan_result, tuikuan_beizhu, gzhOpenid, isjutui = false, bohuiyy = '快递已被取出，请耐心等候派送', ishebing = false) {
    // if (ishebing) {
    ...
    if (!isjutui) { // 已退款通知
        ...
        if (gzhOpenid) {
            ...
            //   tuisongFwh(gzhOpenid, '2LUXA0MIh_snXhI4SDQJwEdXEoePD_zV9YROUFF11ws', msgData)
...
exports.main = async (event, context) => {
    ...
    if (event.action == 'tuikuan') {
        ...
        go_tuikuan_list.forEach(element => {
            ...
            var total_fee = sswr(Number(element.dingdan_money) * 100, 0)
                ...
                cloud.database().collection('tuikuan').doc(tuikuan_id)
                    ...
                    .then(res1 => {
                        ...
                        if (element.dingdanList) {
                            ...
                            tuikuantongzhi(openid, dingdanhao, dingdan_money, tk_time, tuikuan_result, (element.qh_Ma).slice(0, 17) + '等多个', element.gzhOpenid, true, '合并付订单快递已被取出，请耐心等候派送', true)
                        } else {
                            cloud.database().collection('daiqu').doc(daiqu_id)
                                .update({
                                    data: {
                                ...
                                .then(res2 => {
                                    ...
                                    // tuikuantongzhi(openid, dingdanhao, dingdan_money, tk_time, tuikuan_result, tuikuan_beizhu)
                                    tuikuantongzhi(openid, dingdanhao, dingdan_money, tk_time, tuikuan_result, tuikuan_beizhu, element.gzhOpenid, true)
